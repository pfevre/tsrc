...
class Workspace():
    ...
    def set_remotes(self):
        ...
        tsrc.executor.run_sequence(self.manifest.repos, remote_setter)

    def copy_files(self):
        copier = FileCopier(self)
        tsrc.executor.run_sequence(self.manifest.copyfiles, copier)
    ...
    def enumerate_repos(self):
        ...
        self.load_manifest()
        for i, repo in enumerate(self.manifest.repos):
...
class RepoActor(tsrc.executor.Actor):
    def display_item(self, item):
        return item.src


class Cloner(RepoActor):
    def __init__(self, workspace):
        self.workspace = workspace

    @property
    def description(self):
        return "Cloning missing repositories"
...
class Syncer(RepoActor):
    ...
    def sync_repo_to_ref(self, repo_path, ref):
    ...
    def sync_repo_to_branch(self, repo_path):
        try:
